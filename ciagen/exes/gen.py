...
from ciagen.utils.common import get_model_config, ciagen_logger, read_caption
...
class Generator:
    ...
    def __call__(self, paths: Dict[str, str | Path]) -> None:
        ...
        ciagen_logger.info(f"Using the following config : {model_to_use_conf}")
        ...
        if use_captions:
            ...
            ciagen_logger.info("Using captions")
        else:
            real_path_captions = []
        ...
        #     ciagen_logger.info("Using labels")
        # else:
        #     real_labels_path = []
        ...
        ciagen_logger.info(f"Using extractor: {extractor}")
        ciagen_logger.info(f"Using generator: {generator}")

        ciagen_logger.info(f"Results will be saved to {generated_path}")
        ciagen_logger.info(f"Real dataset size: {real_dataset_size}")
